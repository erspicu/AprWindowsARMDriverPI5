<#
.SYNOPSIS  Build the RP1 DesignWare SPI SpbCx controller driver for ARM64.
           Same KMDF + SpbCx recipe as the RP1 I2C driver.
...
$Deliver = "C:\ai_project\AprWindowsDriver\windows_driver\spi"
...
foreach ($s in $Sources) {
    ...
    $a = @("/nologo","/c","/W4","/O2","/Gy","/Zi","/kernel","/GS","/D_WIN64","/DNDEBUG",
           ...
           "/I$IncKmdf","/I$IncSpb","/I$IncKmCrt","/I$IncKm","/I$IncShared","/Fo$obj","/Fd$OutDir\rp1spi.pdb",$s)
    & $Cl @a
...
$Sys = Join-Path $OutDir "rp1spi.sys"
...
$la = @("/nologo","/DRIVER","/SUBSYSTEM:NATIVE,10.0","/MACHINE:$Machine","/NODEFAULTLIB","/INTEGRITYCHECK",
        "/ENTRY:FxDriverEntry","/DEBUG","/PDB:$OutDir\rp1spi.pdb",
