<# Build the BCM2712 PM watchdog KMDF driver for ARM64. #>
[CmdletBinding()]
...
$Deliver="C:\ai_project\AprWindowsDriver\windows_driver\watchdog"
...
foreach($s in $Sources){
  ...
  $a=@("/nologo","/c","/W4","/O2","/Gy","/Zi","/kernel","/GS","/D_WIN64","/DNDEBUG","/DKMDF_VERSION_MAJOR=$KmdfMaj","/DKMDF_VERSION_MINOR=$KmdfMin")+$ArchDefs+@("/I$IncKmdf","/I$IncKmCrt","/I$IncKm","/I$IncShared","/Fo$obj","/Fd$OutDir\bcmwdt.pdb",$s)
...
$Sys=Join-Path $OutDir "bcmwdt.sys"
Write-Host "== Linking ==" -ForegroundColor Cyan
$la=@("/nologo","/DRIVER","/SUBSYSTEM:NATIVE,10.0","/MACHINE:$Machine","/NODEFAULTLIB","/INTEGRITYCHECK","/ENTRY:FxDriverEntry","/DEBUG","/PDB:$OutDir\bcmwdt.pdb","/LIBPATH:$LibKm","/LIBPATH:$LibKmdf","wdfdriverentry.lib","wdfldr.lib","libcntpr.lib","BufferOverflowFastFailK.lib","ntoskrnl.lib","hal.lib","/OUT:$Sys")+$Objs
