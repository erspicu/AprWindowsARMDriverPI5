...
**全章節初稿完成** ✅（第一部 11 章 + 第二部 ~44 個硬體章）。狀態：✅ 已完成 / ✍️ 撰寫中 / 🔲 規劃中。
...
| 11 | [客製 UEFI 韌體：為什麼、是什麼、怎麼做（ACPI 從哪來 + 16GB 案例）](11-custom-uefi-firmware.md) | ✅ |
...
| 章 | 裝置 | 框架 | 狀態 |
|----|------|------|------|
| A1 | [PCIe Root Complex](A01-pcie-root-complex.md) | inbox pci.sys + ACPI | ✅ |
| A2 | [VideoCore 韌體介面 / Mailbox](A02-mailbox.md) | KMDF | ✅ |
| A3 | [BCM2712 clocks / power](A03-bcm2712-clocks-power.md) | 韌體/ACPI | ✅ |
| A4 | [GIC-400 / L2 中斷控制器](A04-gic-interrupts.md) | ACPI MADT | ✅ |
...
| 章 | 裝置 | 框架 | 狀態 |
|----|------|------|------|
| B1 | [RP1 韌體 / mailbox](B01-rp1-firmware.md) | KMDF | ✅ |
...
| B5 | [RP1 USB3 ×2（DesignWare DWC3）](B05-rp1-usb3.md) | inbox xHCI | ✅ |
| B6 | [RP1 DMA（DesignWare AXI-DMA）](B06-rp1-dma.md) | KMDF | ✅ |
| B7 | RP1 UART ×6（PL011-AXI）→ 見 [A10](A10-uart-pl011.md) | SerCx2 | ✅ |
...
| B11 | [RP1 SD/MMC（DesignWare MSHC）](B11-rp1-mmc.md) | SdPort | ✅ |
